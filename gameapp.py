...
CLUE_QUESTIONS = {
    "Is it alive?": lambda w: w in ["elephant", "tiger"],
    "Is it man-made?": lambda w: w in ["chair", "guitar", "rocket", "pencil", "pizza"],
    "Is it typically eaten?": lambda w: w in ["apple", "pizza"],
    "Is it commonly found in a classroom?": lambda w: w in ["chair", "pencil"],
    "Is it used to make music?": lambda w: w == "guitar",
    "Does it live in the wild?": lambda w: w in ["elephant", "tiger"],
    "Can it fly or go to space?": lambda w: w == "rocket",
